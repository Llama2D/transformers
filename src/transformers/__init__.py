...
_import_structure = {
    ...
    "models.llama2d": ["LLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP", "Llama2DConfig"],
...
if TYPE_CHECKING:
    ...
    from .models.llama2d import LLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP, Llama2DConfig
    ...
    try:
        ...
        from .models.llama2d import Llama2DForCausalLM, Llama2DForSequenceClassification, Llama2DModel, Llama2DPreTrainedModel
