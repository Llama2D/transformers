...
from transformers import Llama2DConfig, Llama2DForCausalLM, LlamaTokenizer
...
def write_model(model_path, input_base_path, model_size, tokenizer_path=None, safe_serialization=True):
    ...
    model = Llama2DForCausalLM.from_pretrained(tmp_model_path, torch_dtype=torch.bfloat16, low_cpu_mem_usage=True)
